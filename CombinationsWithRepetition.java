...
public class Main {
    public static void main(String[] args) {
        String elements = "30";
        String forms = "5";
        elements = String.valueOf(Integer.parseInt(elements) + Integer.parseInt(forms) - 1);
        ...
        System.out.print("Combinations with repetition: " + factorial(new BigDecimal(elements)).divide(divisor));
    }
